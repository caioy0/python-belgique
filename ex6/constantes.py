...
# action de Stanley quand on a appuyé sur la touche espace
    SPRAY = 1
# état normal des fleurs, du chat, de la guêpe, de chaque chenille, de Stanley, etc. NORMAL = 0
# état d'un ennemi quand il a terminé son parcours
    TERMINE = 1
# état d'un ami quand il est touché par un ennemi (ex: le chat est touché par la guêpe) TOUCHE = 2
# types d’ami
    FLEUR_HG = 0
    FLEUR_HD = 1
    FLEUR_BG = 2
